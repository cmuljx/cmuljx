...
public class InfSeparationAnalysisAction extends ActionSupport {
private static final long serialVersionUID = 48L;
	...
	public String execute() throws Exception {
		listWeek = infAnalysisService.monthAnalysis(company , startTime , endTime , "cell");
		listCompany = infAnalysisService.companyAnalysis(yearNum , weekNum, startTime, endTime , "cell");

...
$(function() {
	...
	var list;
	function getData(){
		$.post("inf/infNucleinAnalysisAction",$("#infNucleinAnalysisForm").serializeArray(),function(data){
			list = data;
			myChartWeek.setOption({
				title : {
			        text: data.company.replace("疾病预防控制中心","") +'按周次流感核酸检出情况'
			    },
				dataset : {
...
<body>
<div id="infNucleinAnalysis">
	<form id="infNucleinAnalysisForm">
		<table>
			<caption class="caption">流感核酸阳性检出情况</caption>
			<tr>

...
<script>
	$(function() {
		...
		$("#infSeparationReportForm").validate({
			rules: {
				collectionDate: {
					required:true,
					sDate:true
		...
		$("#collectionDate").change(function(){			
			$.post("inf/infReportAction!collectionDateFind",$("#infSeparationReportForm").serializeArray(),function(response){			
				if(response == false){
					$("#massageTD").text("无病毒分离信息。请重新输入收样日期");
...
<body>
	<div id="infSeparationReport" >		
		<form id="infSeparationReportForm" action="inf/infReportAction.action">
			<table>
				...
				<tr id="massageTR">
					...
					<td class="td3">
						<input id="flag" name="flag" type="hidden" value="C"/>
					</td>
					<td class="td4"></td>
				</tr>				
			</table>
			<table>
				...
				<tr>
					...
					<td  class="td2">
						<input id="detectionPrinciple" type="text" name="detectionPrinciple" value="WS 285-2008"/>
					</td>
					<td class="td3">检测方法：</td>
					<td class="td4">
						<input id="detectionMethod" type="text" name="detectionMethod" value="细胞培养"/>
					</td>
				</tr>	
				<tr>
